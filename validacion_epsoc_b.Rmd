...
epsoc4 <-haven::read_spss(paste0(path, '181115 - EPSOC Base parcial 4.sav')) %>% 
  clean_names() %>% 
...
epsoc4$dura.d <- ifelse(nchar(epsoc4$duration) == 8,
                 0, 
                 as.numeric(gsub("\\..*$", "", epsoc4$duration)))

epsoc4$duracion <- hms(gsub("^.*\\.", "", epsoc4$duration))
epsoc4$duracion.t <- as.duration(epsoc4$duracion + 
                                         as.numeric(days(epsoc4$dura.d)))
...
```{r}
knitr::kable(cbind(epsoc4$folio[epsoc4$duracion.t.min < 20],
                (round(epsoc4$duracion.t.min[epsoc4$duracion.t.min < 20],1))), 
...
```{r ent.largas}
knitr::kable(cbind(epsoc4$folio[epsoc4$duracion.t.min > 150],
                (round(epsoc4$duracion.t.min[epsoc4$duracion.t.min > 150]/60,1))), 
...
## Comienzo viñetas
epsoc4$time2 <- ifelse(nchar(epsoc4$time2) == 30, 
                      as.character(strptime(epsoc4$time2,
                              format = "%a %b %d %H:%M:%S %z %Y")), 
                      as.character(ymd_hms(epsoc4$time2)-hours(3)))
epsoc4$time2 <- as_datetime(epsoc4$time2)
epsoc4$time2.hms <- format(epsoc4$time2, format = "%H:%M:%S")
epsoc4$time2.hms <- as.POSIXct(epsoc4$time2.hms, format = "%H:%M:%S")
epsoc4$time2.dmy <- dmy(format(epsoc4$time2, format = "%d-%m-%y"))

## Fin viñetas
epsoc4$time3 <- ifelse(nchar(epsoc4$time3) == 30, 
                      as.character(strptime(epsoc4$time3,
                                            format = "%a %b %d %H:%M:%S %z %Y")), 
                      as.character(ymd_hms(epsoc4$time3)-hours(3)))
epsoc4$time3 <- as_datetime(epsoc4$time3)
epsoc4$time3.hms <- format(epsoc4$time3, format = "%H:%M:%S")
epsoc4$time3.hms <- as.POSIXct(epsoc4$time3.hms, format = "%H:%M:%S")
epsoc4$time3.dmy <- dmy(format(epsoc4$time3, format = "%d-%m-%y"))
...
```{r sexo}
knitr::kable(cbind(epsoc4$folio[epsoc4$sexo.enc != epsoc4$sexo.seleccionado],
                epsoc4$sexo.enc[epsoc4$sexo.enc != epsoc4$sexo.seleccionado],
                epsoc4$sexo.seleccionado[epsoc4$sexo.enc != epsoc4$sexo.seleccionado]), 
