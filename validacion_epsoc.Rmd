...
- `r ifelse(s.cf$fails[grep("durat.*<", s.cf$expression)] == 0, 
       ...
       paste("Existen", s.cf$fails[grep("durat.*<", s.cf$expression)], "entrevistas"))` que duraron más de dos horas.
- `r ifelse(s.cf$fails[grep("durat.*>", s.cf$expression)] == 0, 
       "No existen entrevistas",
       paste("Existen", s.cf$fails[grep("durat.*>", s.cf$expression)], "entrevistas"))` que duraron menos de quince minutos.  
